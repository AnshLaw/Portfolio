...
export default function ContactPage() {
  return <PageLayout><section className="contact-section page-container">
    <div className="contact-intro"><p className="section-kicker">Contact</p>
      <h1>Say hello.</h1>
      <p>Job openings, project ideas, or questions about something I built. Email is fastest; the form works too.</p>
      ...
      <div className="contact-interests"><h2>What I’d like to work on</h2><p>Applied AI · Computer vision · Full-stack products · Open source & research</p></div>
    </div><ContactForm />
  </section></PageLayout>
}
